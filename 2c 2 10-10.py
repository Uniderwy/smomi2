...
Original file is located at
    https://colab.research.google.com/drive/104wxmaBnXEquyXswhFvuAqV0nui3ve04
"""
...
def main():
    ...
    path_train= "/content/drive/My Drive/lab1/folder/train*"
    path_val= "/content/drive/My Drive/lab1/folder/val*"
    ...
    model.compile(
        optimizer=tf.optimizers.Adam(lr=0.0000000002),
        loss=tf.keras.losses.categorical_crossentropy,
        metrics=[tf.keras.metrics.categorical_accuracy],
    )

    log_dir='/content/drive/My Drive/lab1/logs/{}/ilcd-{}'.format(LOG_DIR, time.time())
    #print(log_dir)
    model.fit(
       train_dataset,
       epochs=100,
...
# %tensorboard --logdir "/content/drive/My Drive/lab1/logs/logs"